config.entities.add([ 
  {
    ...
    moveCost: 1,
    eventImg: {
      day:'evt_tile_dry_1.png',
      night: 'evt_tile_dry_1_night.png'
    },
  ...
  },
  {
    ...
    travelParticle: 'pt-travel-dry',
    eventImg: {
      day: 'evt_fxt_cave_1.png',
      night:'evt_fxt_cave_1.png'
    },
    moveSounds: [
      'sfx_move_dry_1', 
      'sfx_move_dry_2', 
  ...
  {
    id: 'tl-mountainSecret',
    extends: 'tl-mountain'
  },
  {
    id: 'tl-mountainTraversable',
    extends: 'tl-mountain',
    moveCost: 3,
    elevation: 1.0,
  },
  ...
  },
  {
    ...
    moveCost: 1,
    eventImg: {
      day:'evt_tile_grass_1.png',
      night: 'evt_tile_grass_1_night.png'
    },
    moveSounds: ['sfx_move_grass_1', 'sfx_move_grass_2', 'sfx_move_grass_3'],
    travelParticle: 'pt-travel-grass',
    sprawls: [
  ...
  },
  {
    ...
    viewCost: 0.1,
    eventImg: {
      day:'evt_tile_shallowRiver_1.png',
      night: 'evt_tile_shallowRiver_1_night.png'
    }, 
    moveSounds: [
      'sfx_move_water_1', 
      'sfx_move_water_2',
  ...
  },
  {
    ...
    viewCost: 0.3,
    eventImg: {
      day:'evt_tile_swamp_1.png',
      night: 'evt_tile_swamp_1_night.png'
    },
    moveSounds: [
      'sfx_move_water_1',
      'sfx_move_water_2',
  ...
  },
  {
    ...
    eventImg: {
      day: 'evt_tile_desert_1.png',
      night: 'evt_tile_desert_1_night.png'
    },
    moveSounds: [
      'sfx_move_dry_1', 
      'sfx_move_dry_2', 
  ...
  },
  {
    ...
    eventImg: {
      day:'evt_tile_hill_1.png',
      night: 'evt_tile_hill_1_night.png'
    },
    moveSounds: [
      'sfx_move_dry_1', 
      'sfx_move_dry_2', 
  ...
  },
  {
    ...
    viewCost: 0.1,
    eventImg: {
      day:'evt_tile_scorched_1.png',
      night:'evt_tile_scorched_1.png',
    }, // Needs proper event image
    travelParticle: 'pt-travel-dry',
    moveSounds: ['sfx_move_dry_1', 'sfx_move_dry_2', 'sfx_move_dry_3'],
    sprawls: [
  ...
  }, 
  {
    ...
    moveCost: 3,
    eventImg: {
      day:'evt_tile_dry_stoneForest_1.png',
      night:'evt_tile_dry_stoneForest_1.png'
    }, // Needs proper event image
    moveSounds: ['sfx_move_dry_1', 'sfx_move_dry_2', 'sfx_move_dry_3'],
    travelParticle: 'pt-travel-dry',
    sprawls: [
  ...
  },
  {
    ...
    sprawls: [
      ...
      {id:'spr-flood', lifeTime:0},
      {id:'spr-geysir-flood', lifeTime:0},
      // {id:'spr-corrupt', lifetime:0, burnedTile: ''},
    ],
    events: 'evt-tile-pit',
  },
  {
    id: 'tl-pit-dry',
    extends: 'tl-pit-desert',
    borderImgIdx: 24,
  },
  {
    id: 'tl-pit-grass',
  ...
  },
  {
    ...
    moveCost: 2,
    eventImg: {
      day:'evt_tile_mushrooms_1.png',
      night:'evt_tile_mushrooms_1.png'
    }, 
    moveSounds: ['sfx_move_grass_1', 'sfx_move_grass_2', 'sfx_move_grass_3'],
    travelParticle: 'pt-travel-grass',
    sprawls: [
  ...
  },
  {
    ...
    moveCost: 4,
    eventImg: {
      day:'evt_tile_shallowSulfur_1.png',
      night: 'evt_tile_shallowSulfur_1_night.png'
    },
  ...
  },
  {
    ...
    viewCost: 0.3,
    eventImg: {
      day:'evt_tile_swamp_sulfur_1.png',
      night:'evt_tile_swamp_sulfur_1_night.png'
    }, // Needs proper event image
    moveSounds: ['sfx_move_water_1', 'sfx_move_water_2', 'sfx_move_water_3','sfx_move_water_4'],
    travelParticle: 'pt-travel-water',
    sprawls: [
  ...
  },
  {
    ...
    events: {
      gameOver: "Your trek was sucked into a dark nothingness."
    },
  },
