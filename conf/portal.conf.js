...
// fixtures
  ...
  },
  {
    ...
    actions: {
      ...
      posTile: {range: '2..', fixtureFlags: '+portalTome'},
      teleport: true,
    },
  },
...
// biomes

  {
    ...
    eventImg: {
      day:'evt_bio_prehistoric_1.png',
      night:'evt_bio_prehistoric_1_night.png'
    },
    tokenIdx: 9,
    terrain: [
      ...
      {perlin: 0.30,  tile: 'tl-jungle-thick'},
      {perlin: 0.0,   tile: 'tl-void'},
    ],
    fixtures: [
      {select: 2, group: 'grp-treasure'},
      {select: 1, group: 'grp-sacrileg'},
      {select: 1, ref: 'fxt-magneticMountain'},
    ],
    zones: [
  ...
  },
  {
    ...
    terrain: [
      ...
      {perlin: 0.30,  tile: 'tl-giantMushrooms'},
      {perlin: 0.0,   tile: 'tl-void'},
    ],
    fixtures: [
      {select: 2, ref: 'fxt-healingSprings'},
  ...
  },
  {
    ...
    fixtures: [
      {select: 2, ref: 'fxt-blessingTemple'},
    ],
  },
])