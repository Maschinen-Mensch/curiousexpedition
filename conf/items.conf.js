config.entities.add([
  ...
  }, 
  {
    ...
    events: {
      ...
      revealTiles: {fixture:true, centerCam:true},
      removeItem: true,
  ...
  },
  {
    ...
    maxStack: 20,
    travelEvent: {
      playSound: 'sfx_travelItem_climbingGear'
    }
  },
  // {
  //   id: 'it-homoLudens',
  //   name: "Homo Ludens",
  //   description: "The book of Play Theory. Increases maximum sanity",
  ...
  },
  {
    ...
    events: {
      ...
      replaceFixtures: [
        { oldFlags: '-mountain -settlement'},
        { oldFlags: '+mountain +secret', new: 'fxt-blessingTemple-secret'},
      ],
      particle: [
        'pt-explosion-rock',
        'pt-explosion-ring',
  ...
  //   id: 'it-easel',
  //   name: "Easel",
  //   description: "A field easel, essential for drawing pictures.",
  //   debugCategory: 'painting',
  //   sprite: 'it_painting_easel_1.png',
  //   maxStack: 1,
  //   value: {base: 30, village: 5},
  // },
  {
    id: 'it-canvas',
    ...
    events: [
      {
        ...
        charEffects: [
          ...
          },
          {
            optional: true,
            reqStatus: '+angry',
            text: "txt-it-nativeTrinket-angry",
          }
        ],
        actions: 'evt-leave',
      },
...
// magic
  ...
  // {
  //   id: 'it-teleportDevice',
  //   name: "txt-it-teleportDevice-name",
  //   description: "txt-it-teleportDevice",
  //   debugCategory: 'magic',
  //    value: {
  //     base: 85,
  //     village: 20,
  ...
  //       posTile: {range:'1..50', fixtureFlags: '+portalDevice'},
  //       teleport: true
  //     },
  //     {
  //       prio: 2,
  //       posTile: {range:'1..3'},
  //       addFixture: {ref:'fxt-portal-device'}
  //     }
  //   ]
  // },
  ...
  //   id: 'it-butterflyNet',
  //   name: "Butterfly net",
  //   description: "Increases chance of finding butterflies by 10%.",
  //   // sprite: 'it_special_butterflynet_1.png',
  //   value: 20,
  //   maxStack: 3,
  //   bonus: {butterflyChance: 0.1}
  // },
...
// ----- Meta Items
  ...
  },
  {
    id: 'il-magic',
    items: [
      // {slots:2, 'it-miniPuppets':1}, 
      // {slots:2, 'it-hornFlute':3},
  ...
  },
  {
    id: 'il-tomePages',
    items: [
      {slots:1, 'it-tomePage-randomTeleport':1},
      {slots:1, 'it-tomePage-healingSprings':1},
      {slots:1, 'it-tomePage-waterfall':1},
      {slots:1, 'it-tomePage-hill':1},
      {slots:1, 'it-tomePage-waterDrain':1},
      {slots:1, 'it-tomePage-superMove':1},
      {slots:1, 'it-tomePage-targetTeleport':1},
      {slots:1, 'it-tomePage-mountain':1},
      {slots:1, 'it-tomePage-chasm':1},
      {slots:1, 'it-tomePage-fire':1},
      {slots:1, 'it-tomePage-fertile':1},
      {slots:1, 'it-tomePage-dry':1},
      {slots:1, 'it-tomePage-abomination':1},
      {slots:1, 'it-tomePage-lake':1},
      {slots:1, 'it-tomePage-regen':1},
      {slots:1, 'it-tomePage-shipReturn':1},
      {slots:1, 'it-tomePage-vision':1},
      //{slots:1, 'it-tomePage-wisdom':1},
      {slots:1, 'it-tomePage-portal':1},
      {slots:1, 'it-tomePage-eagle':1},
    ]
  },
  {
    id: 'il-rival-items',
  ...
  },
  {
    ...
    items: [
      ...
      // {slots:1, 'it-map-shrine':1},
      // {slots:1, 'it-map-village':1},
    ]
  },
  {
    id: 'il-loot-standard',
